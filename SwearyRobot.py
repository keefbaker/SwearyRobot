...
proop = ( "to", "and", "it's", "not too", "less than", "worse than", "the absolute best", "I think", "A pile of", "Astoundingly", "Makes me so happy I could", "not particularly", "in", "similar to" )
